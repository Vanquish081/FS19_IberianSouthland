    ...
    if #spec.wheels > 0 then
        for c,wheel in pairs(spec.wheels) do
            if wheel.tireType ~= 4 then
                ...
                psData.psFile = "particleSystems/dirtPS/dirt2.i3d"
        ...
        if spec.isServer then
            ...
            for c = 1, #spec.wheels do
                ...
                if wheel.inMud then
                    ...
                    self.dirtAmount = dirtAmount + ( (AxleSpeed / 10000) / #spec.wheels / 40 )
                    ...
                    if enableChanges then
                        if wheel.tireType ~= 4 then
                            ...
                            if wheel.onMudBorder then
                                ...
                                frictionCoeff = (math.random(20, 40) / 40) * wheel.widthFactor
                            else
                                ...
                                frictionCoeff = (math.random(15, 32) / 40) * wheel.widthFactor
                            end
